      ...
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <motion.div variants={itemVariants} className="my-12 text-center">
          ...
          <p className="mt-2 text-gray-500 max-w-3xl mx-auto">
            Searching for your dream rental property has never been easier. With our user-friendly searcg
            future, you can quickly find the perfect home that meets all your needs. Starr your search today
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16 text-center">
          {[
            ...
            },
            {
              ...
              description:
                "Once your are found the perfect rental property, easily book it online with just a few clicks.",
            },
            {
